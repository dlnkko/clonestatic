...
const SYMBOL_PATTERNS: { currency: string; re: RegExp }[] = [
  ...
  { currency: 'DKK', re: new RegExp(String.raw`DKK\s*${PRICE_NUM}|${PRICE_NUM}\s*DKK|kr\.?\s*${PRICE_NUM}`, 'gi') },
  { currency: 'HUF', re: new RegExp(String.raw`Ft\s*${PRICE_NUM}|${PRICE_NUM}\s*Ft|HUF\s*${PRICE_NUM}`, 'gi') },
  { currency: 'RON', re: new RegExp(String.raw`lei\s*${PRICE_NUM}|${PRICE_NUM}\s*lei|RON\s*${PRICE_NUM}`, 'gi') },
  { currency: 'UAH', re: new RegExp(String.raw`₴\s*${PRICE_NUM}|${PRICE_NUM}\s*₴|UAH\s*${PRICE_NUM}`, 'gi') },
  { currency: 'BGN', re: new RegExp(String.raw`лв\.?\s*${PRICE_NUM}|${PRICE_NUM}\s*лв|BGN\s*${PRICE_NUM}`, 'gi') },
