...
/**
 * Vector logo — works on any background (no black box like raster PNG).
 * For raster: export PNG with transparent background → /public/logo.png
 */
export function AdmirrorLogo({
  ...
  /** dark = for light backgrounds; light = for dark hero/header */
  theme?: 'dark' | 'light';
