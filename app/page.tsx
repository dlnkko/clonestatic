...
export default function StaticAdPromptGenerator() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Run prompt generation and product image upload in parallel to save time
      ...
      // Call Kie.ai to generate the ad image (nano-banana-2); use pre-uploaded URL if available
  ...
  return (
    <main className="min-h-screen bg-[var(--background)]">
      <div className="mx-auto max-w-[1200px] px-4 py-6 sm:px-6 sm:py-10 lg:py-20">
        ...
        {/* Header */}
        <header className="mb-8 sm:mb-12 lg:mb-16 rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-4 sm:p-6 shadow-sm ring-1 ring-slate-200/50">
        ...
        <div className="grid grid-cols-1 items-start gap-6 sm:gap-8 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="flex flex-col gap-5 sm:gap-6 lg:col-span-5 lg:gap-8">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <label
                    ...
                    className="group relative flex aspect-[4/5] w-full cursor-pointer flex-col items-center justify-center overflow-hidden rounded-xl sm:rounded-2xl border-2 border-[var(--border)] bg-slate-50/80 transition-all hover:border-[var(--accent-border)] hover:bg-blue-50/30 active:scale-[0.99]"
                  >
                    {staticAdPreview ? (
                      ...
                      <div className="flex flex-col items-center gap-2 sm:gap-3 text-center p-2 sm:p-4">
                        <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-white shadow-sm ring-1 ring-slate-200">
                          <svg className="h-5 w-5 text-slate-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>
                        </div>
                        <div>
                          <p className="text-xs sm:text-sm font-medium text-slate-700">Reference Ad</p>
                          <p className="mt-0.5 text-[10px] sm:text-[11px] text-slate-500">Style to copy</p>
                        </div>
                      </div>
                    )}
                  </label>
                  ...
                  >
                    {productPreview ? (
                      ...
                      <div className="flex flex-col items-center gap-2 sm:gap-3 text-center p-2 sm:p-4">
                        ...
                        <div>
                          <p className="text-xs sm:text-sm font-medium text-slate-700">Your Product</p>
                          <p className="mt-0.5 text-[10px] sm:text-[11px] text-slate-500">PNG ideal</p>
                        </div>
                      </div>
                    )}
                  </label>
                ...
                <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-2">
                  {(['9:16', '16:9', '1:1', 'auto'] as const).map((size) => (
                    <button
                      ...
                      className={`min-h-[44px] rounded-xl border px-3 py-2.5 text-xs font-medium transition-all touch-manipulation ${
                        imageSize === size
                          ? 'border-[var(--primary)] bg-[var(--primary)] text-white shadow-sm'
                          : 'border-[var(--border)] bg-white text-slate-600 hover:border-[var(--accent-border)] hover:bg-[var(--accent-soft)]'
                      }`}
                    >
            ...
            <section className="space-y-4 rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-4 sm:p-5 shadow-sm ring-1 ring-slate-200/30">
              <div className="flex items-center justify-between gap-2">
                <h2 className="text-sm font-semibold text-slate-800 sm:text-base">2. Context</h2>
                <span className="rounded-full bg-slate-100 px-2.5 py-1 text-[10px] font-medium tracking-wide text-slate-500 shrink-0">OPTIONAL</span>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-xl border border-[var(--border)] bg-white px-4 py-3 pl-10 text-sm text-slate-900 placeholder:text-slate-400 focus:border-[var(--accent)] focus:outline-none focus:ring-2 focus:ring-[var(--accent-soft)] transition-all min-h-[48px]"
                    />
                  ...
                  {copywriting.trim() && isValidUrl(copywriting.trim()) && (
                    <p className="mt-2 flex items-center gap-1.5 text-xs text-emerald-600">
                      <svg className="h-3.5 w-3.5 shrink-0" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"/><path d="m9 12 2 2 4-4"/></svg>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full resize-none rounded-xl border border-[var(--border)] bg-white px-4 py-3 text-sm text-slate-900 placeholder:text-slate-400 focus:border-[var(--accent)] focus:outline-none focus:ring-2 focus:ring-[var(--accent-soft)] transition-all min-h-[88px]"
                  />
                </div>
              </div>
            </section>
            ...
            <div className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-4 sm:p-5 shadow-sm ring-1 ring-slate-200/30">
              <button
                ...
                className="group relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-xl bg-[var(--primary)] px-4 py-4 sm:py-3.5 text-sm font-medium text-white shadow-lg shadow-blue-200/40 transition-all hover:bg-[var(--primary-hover)] disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-[var(--primary)] min-h-[52px] touch-manipulation"
              >
                {isGenerating ? (
                  <>
              ...
              <div className="flex items-center justify-between border-b border-slate-200 bg-[var(--card-bg)] px-4 py-3">
                ...
                {generatedImageUrl && (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 rounded-lg border border-[var(--border)] bg-white px-3 py-2 text-xs font-medium text-slate-600 shadow-sm transition hover:bg-[var(--accent-soft)] hover:border-[var(--accent-border)] min-h-[40px] items-center"
                  >
              ...
              <div className="relative flex flex-1 flex-col items-center justify-center p-4 sm:p-6 min-h-[280px] sm:min-h-[360px] lg:min-h-[400px]">
                {!generatedImageUrl && !isGenerating && !isGeneratingImage ? (
                  <div className="flex flex-col items-center justify-center text-center px-2">
                    <div className="mb-3 sm:mb-4 flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center rounded-2xl border-2 border-dashed border-slate-300 bg-white">
                    ...
                    <p className="mt-1 max-w-[260px] text-xs text-slate-500">
                      Upload both images and tap Generate Image.
                    </p>
                  </div>
                ) : (isGenerating || isGeneratingImage) ? (
                  <div className="flex flex-col items-center justify-center text-center">
                    <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl border-2 border-[var(--border)] bg-white">
                  ...
                  <div className="w-full flex flex-col items-center">
                    ...
                    <div className="mt-4 flex flex-wrap items-center justify-center gap-2 sm:gap-3">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 rounded-xl border border-[var(--border)] bg-white px-4 py-2.5 text-xs font-medium text-slate-600 shadow-sm transition hover:bg-[var(--accent-soft)] hover:border-[var(--accent-border)] min-h-[44px]"
                      >
                        <svg className="h-3.5 w-3.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
                        Open
                      </a>
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-xl border border-[var(--primary)] bg-[var(--primary)] px-4 py-2.5 text-xs font-medium text-white shadow-sm transition hover:bg-[var(--primary-hover)] min-h-[44px] touch-manipulation"
                      >
